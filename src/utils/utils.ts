...
export const encryptKeccak256 = (str: string): string => {
  return toHex(str);
};

export const strToBigint = (str: string, decimals: number = 18): bigint => {
...
export const bigintToStr = (amount: bigint | string, decimals: number = 18): string => {
...
export const mumbaiEtherscanURL = 'https://polygon-mumbai.infura.io';
